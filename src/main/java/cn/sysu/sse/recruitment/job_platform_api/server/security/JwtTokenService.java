...
public class JwtTokenService {
	...
	public String generateToken(String subject, Map<String, Object> claims) {
		logger.info("开始生成JWT token，subject：{}", subject);
		Date now = new Date();
		...
		String token = Jwts.builder()
				...
				.compact();
		logger.info("JWT token生成成功，subject：{}，过期时间：{}", subject, exp);
		return token;
	}
